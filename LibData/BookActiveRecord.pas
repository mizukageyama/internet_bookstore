...
uses
  ...
  MVCFramework.SQLGenerators.MySQL, BookContextIntf, ActiveRecordEntity;
...
type
  ...
  public
    ...
    constructor Create(const ABook: TBookActiveRecord); overload;
...
constructor TBookActiveRecord.Create(const ABook: TBookActiveRecord);
begin
