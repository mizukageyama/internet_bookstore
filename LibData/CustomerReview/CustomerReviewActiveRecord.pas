...
type
  ...
  TCustomerReviewActiveRecord = class(TMVCActiveRecord, ICustomerReviewContext)
  private
    ...
    FBookId: NullableInt64;
    [MVCTableField('REVIEW')]
    FReview: NullableString;
...
function TCustomerReviewActiveRecord.QueryInterface(const IID: TGUID;
  out Obj): HRESULT;
begin
  Result := -1;
end;

function TCustomerReviewActiveRecord._AddRef: Integer;
begin
  Result := -1;
end;

function TCustomerReviewActiveRecord._Release: Integer;
begin
  Result := -1;
end;
