...
begin
  ...
  FReviewServiceProxy := TCustomerReviewService
  ...
  FWriteReviewPresenter := FViewPresenterFactoryStub
    .CreateWriteReviewPresenter(FWriteReviewViewStub, FReviewServiceProxy,
      FSelectedBook);
end;
...
begin
  ...
  var ListBeforeInsert := FReviewServiceProxy
    .GetCustomerReviewsByBookId(FSelectedBook.Id);
  FWriteReviewPresenter.SubmitReview;

  var ListAfterInsert := FReviewServiceProxy
    .GetCustomerReviewsByBookId(FSelectedBook.Id);
